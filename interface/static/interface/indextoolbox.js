...
Toolbox.addSeperationBefore(Toolbox.categories[6], toolboxXML);
Toolbox.addSeperationBefore(Toolbox.categories[8], toolboxXML);
...
Toolbox.listsCategory = Toolbox.categories[4];
...
Toolbox.colourCategory = Toolbox.categories[5];
...
// Toolbox.addBlock('<block type="component_create"></block>', Toolbox.componentCategory);
